...
class AppStatus(Enum):
    ...
    ERROR_NOTIFICATION_ID_NOT_EXISTED = status.HTTP_404_NOT_FOUND, 404, 'NOTIFICATION_ID_NOT_EXISTED'
    ERROR_USER_NOT_FOUND = status.HTTP_404_NOT_FOUND, 404, 'ACCOUNT_NOT_EXIST'
    ERROR_JOB_NOT_FOUND = status.HTTP_404_NOT_FOUND, 404, 'JOB_NOT_FOUND'
    ERROR_TASK_NOT_FOUND = status.HTTP_404_NOT_FOUND, 404, 'TASK_NOT_FOUND'
    ERROR_CAMPAIGN_NOT_FOUND = status.HTTP_404_NOT_FOUND, 404, 'CAMPAIGN_NOT_FOUND'
    ERROR_TOOL_RUN_NOT_FOUND = status.HTTP_404_NOT_FOUND, 404, 'TOOL_RUN_NOT_FOUND'
    ...
    ERROR_PROJECT_METHOD_NOT_ALLOWED = status.HTTP_405_METHOD_NOT_ALLOWED, 405, 'PROJECT_METHOD_NOT_ALLOWED'
    ERROR_JOB_METHOD_NOT_ALLOWED = status.HTTP_405_METHOD_NOT_ALLOWED, 405, 'JOB_METHOD_NOT_ALLOWED'
    ERROR_TASK_METHOD_NOT_ALLOWED = status.HTTP_405_METHOD_NOT_ALLOWED, 405, 'TASK_METHOD_NOT_ALLOWED'
    ERROR_CROWD_BOT_METHOD_NOT_ALLOWED = status.HTTP_405_METHOD_NOT_ALLOWED, 405, 'CROWD_BOT_METHOD_NOT_ALLOWED'

    ERROR_ACCOUNT_ALREADY_EXIST = status.HTTP_409_CONFLICT, 409, 'ACCOUNT_ALREADY_EXIST'
    ERROR_ALREADY_JOINED_TO_PROJECT = status.HTTP_409_CONFLICT, 409, 'ALREADY_JOINED_TO_PROJECT'
    ...
    ERROR_PROJECT_NOT_FOUND = status.HTTP_302_FOUND, 302, 'PROJECT_NOT_EXIST'
    ERROR_OWNER_NOT_FOUND = status.HTTP_302_FOUND, 302, 'PROJECT_OWNER_NOT_EXIST'
    ERROR_PROJECT_CONFIG_FOUND = status.HTTP_302_FOUND, 302, 'PROJECT_CONFIG_NOT_EXIST'
    ERROR_PROJECT_KEY_CONFLICT = status.HTTP_409_CONFLICT, 409, 'PROJECT_KEY_ALREADY_EXIST'
    ERROR_PROJECT_UNAUTHORIZED = status.HTTP_401_UNAUTHORIZED, 401, 'PROJECT_UNAUTHORIZED'
