...
from ..schemas import CommentCreate, CommentUpdate, CommentCreateParams, CommentUpdateParams, CommentResponse
...
class CommentService:
    ...
    async def create_comnent_to_post(self, user_id: str, comment: CommentCreateParams):
